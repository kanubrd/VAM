...
const productImages: Record<string, string> = {
  ...
  'suspol-125':     '/suspol-125-product-polished-final.png',
...
const productSliderImages: Record<string, string[]> = {
  ...
  'suspol-125':     ['/suspol-125-product-polished-final.png', '/suspol-125-application.png'],
...
const productSliderAltText: Record<string, string[]> = {
  ...
  'vamshield-90':   [
    'VAMShield-90 ash-free corrosion inhibitor white powder in laboratory dish',
    'VAMShield-90 industrial application in metalworking and hydraulic fluids',
    'VAMShield-90 application in gear machining and metal cutting lubrication',
    'VAMShield-90 advanced metal cutting and lubrication in precision milling machine'
  ],
  'suspol-125':     [
    'SusPol-125 bio-based castor oil polyol for sustainable coatings',
    'SusPol-125 protective coating application on heavy steel construction beams'
  ],
  'vam-rc-01':      [
