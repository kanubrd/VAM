...
const productsData: Record<string, ProductDetail> = {
  'metals-alloys': {
    ...
    image: '/images/solutions/metals-alloys.png',
  ...
  'polymers-composites': {
    ...
    image: '/images/solutions/polymers-composites.png',
  ...
  'coatings-surface-chemicals': {
    ...
    image: '/images/solutions/coatings-chemicals.png',
  ...
  'compliance-certification': {
    ...
    image: '/images/solutions/compliance-certs.png',
  ...
  'multi-site-fulfillment': {
    ...
    image: '/images/solutions/multi-site-fulfillment.png',
  ...
  'inventory-intelligence': {
    ...
    image: '/images/solutions/predictive-reorder.png',
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.valtrixmaterials.com/solutions/${slug}`,
    },
  };
}
